...
- **Query boosting** (`Subscriber/ElasticsearchSearchSubscriber.php`): match_phrase (1M), match AND (500K), delimiter AND (200K), wildcard (15K), prefix (1.1K). Boosts wrapped in `ConstantScoreQuery` for name fields to avoid length normalisation.
